...
export default function RoomEditModal({
    ...
    return (
        <Dialog open={!!open} onClose={saving || deleting ? undefined : onClose} maxWidth="xs" fullWidth {...props}>
            <DialogTitle data-cy="room-edit-modal-title">
                แก้ไขข้อมูลห้อง
            </DialogTitle>
                ...
                <Stack spacing={2} sx={{ mt: 1 }}>
                    {loading ? (
                        <Stack
                            ...
                            alignItems="center"
                            spacing={2}
                            data-cy="room-edit-modal-loading-state"
                        >
                        ...
                        <>
                            <TextField
                                ...
                                required
                                fullWidth
                                data-cy="room-edit-modal-number-input"
                            />
                            <TextField
                                select
                                label="สถานะ"
                                ...
                                required
                                fullWidth
                                data-cy="room-edit-modal-status-select"
                            >
                                {STATUS_OPTIONS.map(opt => (
                                    <MenuItem
                                        key={opt.value}
                                        value={opt.value}
                                        data-cy={`room-edit-modal-status-option-${opt.value.toLowerCase()}`}
                                    >
                                        {opt.label}
                                    </MenuItem>
                                ))}
                            ...
                            {error && (
                                <Alert
                                    severity="error"
                                    data-cy="room-edit-modal-error-alert"
                                >
                                    {error}
                                </Alert>
                            )}
            ...
            <DialogActions>
                <Button
                    ...
                    data-cy="room-edit-modal-delete-button"
                >
                    ลบห้อง
                </Button>
                ...
                <Button
                    ...
                    data-cy="room-edit-modal-cancel-button"
                >
                    ยกเลิก
                </Button>
                <Button
                    ...
                    data-cy="room-edit-modal-save-button"
                >
