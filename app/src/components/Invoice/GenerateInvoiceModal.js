 ...
 */
export default function GenerateInvoiceModal({ open, onClose, onCreated, roomId, ...props }) {
    ...
    return (
        <Dialog open={!!open} onClose={handleClose} maxWidth="sm" fullWidth {...props}>
            <DialogTitle sx={{ pb: 1 }} data-cy="generate-invoice-modal-title">
                สร้างใบแจ้งหนี้{' '}
                {!roomId && (
            ...
            <DialogContent dividers>
                {error && (
                    <Alert
                        severity="error"
                        sx={{ mb: 2 }}
                        data-cy="generate-invoice-modal-error-alert"
                    >
                        {error}
                    </Alert>
                )}
                    ...
                    <Grid container spacing={2} sx={{ mb: 2 }}>
                        <Grid item xs={12}>
                            <TextField
                                ...
                                data-cy="generate-invoice-room-number-input"
                            />
                        </Grid>
                    </Grid>
                )}
                ...
                <Grid container spacing={2} sx={{ mb: 2 }}>
                    <Grid item xs={7}>
                        <TextField
                            ...
                            inputProps={{ min: 1900 }}
                            data-cy="generate-invoice-year-input"
                        />
                    </Grid>
                    <Grid item xs={5}>
                        <TextField
                            ...
                            data-cy="generate-invoice-month-input"
                        />
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={2} sx={{ mb: 2 }}>
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            data-cy="generate-invoice-issue-date-input"
                        />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <TextField
                            ...
                            InputLabelProps={{ shrink: true }}
                            data-cy="generate-invoice-due-date-input"
                        />
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={2} sx={{ mb: 2 }}>
                    <Grid item xs={6}>
                        <TextField
                            ...
                            data-cy="generate-invoice-electricity-units-input"
                        />
                    </Grid>
                    <Grid item xs={6}>
                        <TextField
                            ...
                            inputProps={{ step: '0.01' }}
                            data-cy="generate-invoice-electricity-rate-input"
                        />
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={2} sx={{ mb: 2 }}>
                    <Grid item xs={6}>
                        <TextField
                            ...
                            inputProps={{ step: '0.01' }}
                            data-cy="generate-invoice-water-units-input"
                        />
                    </Grid>
                    <Grid item xs={6}>
                        <TextField
                            ...
                            inputProps={{ step: '0.01' }}
                            data-cy="generate-invoice-water-rate-input"
                        />
                    </Grid>
                </Grid>
                ...
                <Grid container spacing={2} sx={{ mb: 1 }}>
                    <Grid item xs={12}>
                        <TextField
                            ...
                            inputProps={{ step: '0.01' }}
                            data-cy="generate-invoice-other-baht-input"
                        />
                    </Grid>
                </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    ...
                                    data-cy="generate-invoice-include-common-fee-checkbox"
                                />
                            }
                        ...
                        {!includeCommonFee && (
                            <TextField
                                ...
                                sx={{ mt: 1 }}
                                data-cy="generate-invoice-custom-common-fee-input"
                            />
                        )}
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    ...
                                    data-cy="generate-invoice-include-garbage-fee-checkbox"
                                />
                            }
                        ...
                        {!includeGarbageFee && (
                            <TextField
                                ...
                                inputProps={{ step: '0.01', min: '0' }}
                                sx={{ mt: 1 }}
                                data-cy="generate-invoice-custom-garbage-fee-input"
                            />
                        )}
                    </Grid>
                </Grid>
                ...
                <Stack spacing={1} sx={{ mt: 2 }}>
                    ...
                    <ToggleButtonGroup
                        ...
                        size="small"
                        data-cy="generate-invoice-open-after-group"
                    >
                        <ToggleButton
                            value="print"
                            data-cy="generate-invoice-open-after-print-button"
                        >
                            Print View
                        </ToggleButton>
                        <ToggleButton
                            value="pdf"
                            data-cy="generate-invoice-open-after-pdf-button"
                        >
                            PDF
                        </ToggleButton>
                    </ToggleButtonGroup>
            ...
            <DialogActions sx={{ px: 3, py: 2 }}>
                <Button
                    onClick={handleClose}
                    disabled={loading}
                    data-cy="generate-invoice-modal-cancel-button"
                >
                    Cancel
                </Button>
                <Button
                    ...
                    disabled={loading}
                    startIcon={loading ? <CircularProgress size={18} color="inherit" data-cy="generate-invoice-modal-create-spinner" /> : null}
                    data-cy="generate-invoice-modal-create-button"
                >
                    Create
                </Button>
            </DialogActions>
